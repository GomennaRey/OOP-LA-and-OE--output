...
hero_mm1 = hero("Moskov", "Marksman", "attack damage", 2460, 448, 123)
hero_fighter1 = hero("Zilong", "Fighter", "attack damage", 2698, 0, 129)
hero_mid1 = hero("Xavier", "Mid", "Magic Damage", 2616, 270, 111)
hero_roam1 = hero("Rafaela", "Roam", "Healing", 2221, 545, 120)
hero_jungle1 = hero("Alpha", "Jungle", "Brust Damage", 2709, 0, 126)
